...
export const LoginForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6" dir="rtl">
      <Card className="w-full max-w-md shadow-xl border-0 bg-gradient-to-br from-white to-slate-50">
        <CardHeader className="text-center pb-6">
          ...
          <CardTitle className="text-2xl text-slate-800">الخطة</CardTitle>
          <p className="text-slate-600">منصة مقارنة المحتوى التعليمي</p>
        </CardHeader>
        <CardContent>
